...
data = pd.read_csv('last_tests/log_logistic_v0.csv', header=None)
runtimes_logistic_0 = data.to_numpy()[:, metric_column_index]

data = pd.read_csv('incomplete_test/log_logistic_v0.csv', header=None)
runtimes_logistic_0_ref = data.to_numpy()[:, metric_column_index]

data = pd.read_csv('incomplete_test/log_oct_h_inc.csv', header=None)
...
data = pd.read_csv('last_tests/log_logistic_v1_ref_new.csv', header=None)
runtimes_logistic_1_ref = data.to_numpy()[:, metric_column_index]

data = pd.read_csv('incomplete_test/log_sap_l2.csv', header=None)
runtimes_l2 = data.to_numpy()[:, metric_column_index]

data = pd.read_csv('incomplete_test/log_sap_sfs.csv', header=None)
...
runtimes = np.row_stack((1-runtimes_oct, 1-runtimes_logistic_0_ref, 1-runtimes_l2, 1-runtimes_sfs))
...
make_fval_profile(runtimes, labels=['OCT-H', 'OLCT', 'MARGOT', 'SFS-MARGOT'], metric_name='1-Bacc', max_tau=10)
