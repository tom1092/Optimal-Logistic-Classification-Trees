...
data = pd.read_csv('temp/log_oct.csv', header=None)
...
data = pd.read_csv('temp/log_margot_hfs.csv', header=None)
...
runtimes = np.row_stack((-runtimes_oct, -runtimes_logistic_0_ref))
